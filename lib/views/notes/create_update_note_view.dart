...
class _CreateUpdatNoteViewState extends State<CreateUpdatNoteView> {
  ...
  Future<CloudNote> createOrGetExistingNote(BuildContext context) async {
    final widgetNote = context.getArgument<
        CloudNote>(); // noteslistviewden ontap function u ile gelirken arguments veriyor bir note değişkenini, burada da
    //argument var mı bu türden diye çekiyor. (Eğitimden sonra yazdım bunu)
